...
public interface WineryService {
    ...
    Float calculateAverageRating(Collection<Float> ratings);
    void save(winery winery);

    winery saveWithUpdatedRating(Long wineryId, Float newRating);
    Float submitRating(Long wineryId, Float newRating);
}